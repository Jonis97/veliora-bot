...
_PREVIEW_SYSTEM_PHRASES = (
    ...
    "All words used in example sentences and mini practice tasks\n"
    "must use simple, natural, level-appropriate everyday vocabulary.\n\n"
    "Do NOT use in examples or tasks:\n"
    "- scientific terms\n"
    "- medical terms\n"
    "- technical or academic vocabulary\n"
    "- source-heavy terminology that students would not normally say in conversation\n\n"
    "Examples and tasks must help students focus on grammar,\n"
    "not on understanding difficult content words.\n\n"
    "Use:\n"
    "- simple spoken words connected to the topic\n"
    "- vocabulary that students at this level can understand immediately\n"
    "- natural classroom and real-life language\n\n"
    "Rule:\n"
    "Example and task vocabulary must always be easier\n"
    "than the original source language.\n\n"
    "Apply to ALL levels A1, A2, B1, B2.\n\n"
    "GRAMMAR POINT SELECTION RULE:\n"
    "Before choosing grammar ask:\n"
    '"What grammar will help this student speak about this topic most easily?"\n\n'
    "EXPLANATION RULES:\n"
