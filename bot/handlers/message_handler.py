...
_PREVIEW_PATCH_SYSTEM = (
    ...
    "ROOM-SPECIFIC SIMPLIFY:\n\n"
    "Lesson:\n"
    "- simplify question vocabulary\n"
    "- shorten sentence wording\n"
    "- keep the same number of questions unless the teacher asks for more or fewer\n\n"
    "Speaking:\n"
    "- make questions shorter and more personal\n"
    "- remove abstract phrasing\n"
    "- keep the same number of questions unless the teacher asks for more or fewer\n\n"
    "Vocabulary:\n"
    "- use simpler words and shorter examples\n"
    "- keep the same number of words unless the teacher asks for more or fewer\n\n"
    "Grammar:\n"
    "- make the explanation shorter and clearer\n"
    "- simplify examples\n"
    "- make the practice task shorter or easier\n"
    "- do not increase the number of examples or tasks unless the teacher asks for more"
)
