...
_VOCABULARY_PROMPT_BODY = (
    ...
    "QUALITY TEST for each word:\n"
    '"Can an average person use this word when talking to a friend about this topic?"\n'
    "If NO → remove it and replace it with a simpler word.\n\n"
    "LEVEL CEILING:\n"
