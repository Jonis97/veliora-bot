...
_PREVIEW_PATCH_SYSTEM = (
    ...
    "VOCABULARY — додати:\n"
    "- if the teacher gives an exact number, add exactly that number of words\n"
    "- if no number is given, add a small minimal amount appropriate to the request, never more than 3\n"
    "- keep all existing words and examples unchanged unless the teacher explicitly asks otherwise\n\n"
    "GRAMMAR — спростити:\n"
